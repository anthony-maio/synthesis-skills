...
**Most tasks need only `references/elements-of-style/03-elementary-principles-of-composition.md`** — it covers active voice, positive form, concrete language, and omitting needless words.
...
Writing for humans? Load the relevant section from `references/elements-of-style/` and apply the rules. For most tasks, `references/elements-of-style/03-elementary-principles-of-composition.md` covers what matters most.
